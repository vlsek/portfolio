const translations = {
    en: {
        ...
        p_job2_li3: "Administered telemetry monitoring on specialized software built in-house for space-industry tasks, built technical documentation from scratch, used LLM scripts for log parsing",
    ...
    ru: {
        ...
        p_job2_li3: "Администрировал мониторинг телеметрии на специализированном ПО, разработанном под задачи космической отрасли, с нуля выстраивал техническую документацию, использовал LLM-скрипты для разбора логов",
